...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    <div className='relative overflow-hidden h-[89vh] w-full bg-gray-200 flex justify-center items-center dark:bg-slate-950 dark:text-white duration-300'>
      <div className='h-full w-[700px] bg-primary/60 absolute -top-1/2 right-0 rounded-3xl rotate-45 -z[8]'></div>
