...
function Banner() {
  return (
    <div className='min-h-[550px] sm:h-[89vh] flex justify-center items-center py-12 sm:py-0'>
      <div className='container'>

        {/* Winter Sale Banner */}
        <div className="bg-red-500 text-white text-center py-3 font-semibold text-lg mb-10">
          Winter Sale! Hurry up ⏰
        </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
          ...
          <div className='flex flex-col justify-center gap-6 sm:pt-0'>
            ...
            <p data-aos="fade-up" className='text-sm text-gray-500 tracking-wide leading-5'>
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rem, sed! Esse accusantium cumque quod laborum consequatur omnis, minima et corporis accusamus odio ipsa provident est aut minus saepe, pariatur explicabo!
            </p>
